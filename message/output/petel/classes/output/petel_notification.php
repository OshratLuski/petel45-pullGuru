...
/**
 * Contains class used to prepare a petel notification for display.
 *
...
namespace message_petel\output;
...
/**
 * Class to prepare a petel notification for display.
 *
 * @package   message_petel
 * @copyright 2016 Ryan Wyllie <ryan@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class petel_notification implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if (!empty($context->component) && substr($context->component, 0, 4) == 'mod_') {
            ...
            $iconurl = $output->image_url('marker', 'message_petel');
        }

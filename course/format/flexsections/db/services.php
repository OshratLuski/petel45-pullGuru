...
$functions = array(
    ...
    'format_flexsections_version_download' => array(
        'classname' => 'format_flexsections_external',
        'methodname' => 'version_download',
        'classpath' => 'course/format/flexsections/externallib.php',
        'description' => 'Function to activity version download',
        'type' => 'write',
        'ajax' => true,
    ),
    'format_flexsections_get_info' => array(
        'classname' => 'format_flexsections_external',
        'methodname' => 'get_info',
        'classpath' => 'course/format/flexsections/externallib.php',
        'description' => 'Get information about the cersion',
        'type' => 'read',
        'ajax' => true,
    ),
);

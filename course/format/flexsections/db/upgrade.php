...
function xmldb_format_flexsections_upgrade($oldversion) {
    ...
    if ($oldversion < 2024120801) {
        ...
        upgrade_plugin_savepoint(true, 2024120801, 'format', 'flexsections');
    }

    if ($oldversion < 2024120802) {
        if (!is_numeric(get_config('format_flexsections', 'maxsectiondepth'))) {
            set_config('maxsectiondepth', 10, 'format_flexsections');
        }
    }

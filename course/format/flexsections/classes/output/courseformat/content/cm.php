...
class cm extends \core_courseformat\output\local\content\cm {
    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        // Intro of mod.
        if ($this->mod->modname == 'questionnaire' && $this->mod->showdescription) {
            $obj = $DB->get_record($this->mod->modname, ['id' => $this->mod->instance]);
            if (isset($obj->intro) && ! empty($obj->intro)) {
                $data->altcontent .= $obj->intro;
            }
        }

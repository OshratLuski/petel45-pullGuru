...
$string['vplhavegrade'] = 'הוגש וניתן ציון';
$string['vplnotsubmitted'] = 'טרם הוגש';
$string['vplwithoutgrades'] = 'ממתין לבדיקה';
$string['studentfailed'] = '{$a} תלמידים נכשלו';
$string['cut_of_date'] = 'טרם הוגש - באיחור';
...
$string['clickformoreinformationandupdateoptions'] = 'במאגר המשותף קיימת גרסה עדכנית, הקליקו למידע נוסף ואפשרות לעדכון';
$string['downloadtheversionofthisactivity'] = 'הורד את הגרסה של פעילות זו';
$string['close'] = 'סגור';
$string['titlepopupinfoblock'] = 'מידע אודות פריט מקורי במאגר';
$string['downloadtheversionomessage'] = 'בקשה נקלטה, פעילות תתווסף לסוף היחידה ותתחיל בשם העתק...';
$string['textversion'] = 'שימו לב! 
<br>
במאגר קיימת גרסה חדשה של פעילות <span style="font-weight: bold">{$a->name}</span>
<br> היסטוריית עדכונים:  
<br> {$a->version_history} 
<br>
של הפעילות המקורית במאגר
<br>
האם ברצונך לעתיק את הגרסה העדכנית של הפעילות הזאת?
<br>
הערה: הפעילות תתווסף לסוף היחידה ותתחיל בשם העתק...';
...
$string['vplhavegrade'] = 'Graded';
$string['vplnotsubmitted'] = 'Not submitted';
$string['vplwithoutgrades'] = 'Needs grading';
...
// Cache.
$string['cachedef_format_flexsections_cache'] = 'Flexible sections format';

$string['clickformoreinformationandupdateoptions'] = 'In the shared repository, an updated version is available. Click for more information and update options.';
$string['downloadtheversionofthisactivity'] = 'Download the version of this activity';
$string['close'] = 'Close';
$string['titlepopupinfoblock'] = 'Inforamtion about activity shared from repository';
$string['downloadtheversionomessage'] = 'Submit is enabled, This new version will be enabled at the end of this section';
$string['textversion'] = 'Note! 
<br> A new version of the activity {$a->name}
 <br> History of the  {$a->description}
 Do you wish to download it for version {$a->version}
 <br>
 Note: The activity will be added at the end of the unit and will start with the name "Copy...". ';

<?php
   ...
   /**
    * Event for AI Analytics creation.
    *
    * This event is triggered when a new AI Analytics instance is created.
    */
   class ai_analytics_created extends base {
       ...
       public static function get_name() {
           return get_string('eventaianalyticscreated', 'qtype_diagnosticadv');
       }
       ...
       public function get_description() {
           return "The AI Analytics event with id '{$this->objectid}' was created.";
       }

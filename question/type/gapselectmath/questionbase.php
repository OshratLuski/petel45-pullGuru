 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_gapselectmath_question_base extends question_graded_automatically_with_countback {
     ...
     * The values are arrays of qtype_gapselectmath_choice objects (or a subclass).
     */
    public $choices;
     ...
     * @param qtype_gapselectmath_choice $choice one of the choices for a place.
     * @return string.
     */
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseputananswerineachbox', 'qtype_gapselectmath');
    }

 ...
 */
function hvp_add_editor_assets($question = null, $mformid = null, $itemid = null) {
    global $PAGE, $CFG;
    ...
    $settings['editor'] = array(
      'filesPath' => $filespathbase . 'content/' . $itemid . '/',
      'fileIcon' => array(
      ...
      'formId' => $mformid,
        ...
        'bidi' => get_config('qtype_hvp', 'bidi'),
        'editordirsupport' => get_config('qtype_hvp', 'editordirsupport'),
        'contentlang' => get_config('qtype_hvp', 'contentlang'),
      'hub' => [

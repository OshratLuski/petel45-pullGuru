...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        ...
        $settingspage->add(new admin_setting_heading('qtype_hvp/ckeditor_buttons', get_string('ckeditorbuttons', 'qtype_hvp'), ''));
        $settingspage->add(new admin_setting_configcheckbox('qtype_hvp/bidi',
            get_string('ckeditorbutton_bidi', 'qtype_hvp'), get_string('ckeditorbutton_bidi_help', 'qtype_hvp'), 1));
        $settingspage->add(new admin_setting_configcheckbox('qtype_hvp/editordirsupport',
            get_string('editordirsupport', 'qtype_hvp'), get_string('editordirsupport_help', 'qtype_hvp'), 1));
        $settingspage->add(new admin_setting_configcheckbox('qtype_hvp/contentlang',
            get_string('contentlang', 'qtype_hvp'), get_string('contentlang_help', 'qtype_hvp'), 1));
    }

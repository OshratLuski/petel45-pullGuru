...
class xapi_result {
    ...
    public static function handle_ajax() {
        ...
        // Then store results.
        $questionattemptid = isset($xapijson->statement->object->moreinfo->questionattemptid) ? $xapijson->statement->object->moreinfo->questionattemptid : optional_param('questionattemptid', '0', PARAM_INT);
        $qaid = (Array)$questionattemptid;

...
class backup_qtype_hvp_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_hvp_structure() {
        ...
        $hvp->annotate_files('qtype_hvp', 'editor', null);
        $hvp->annotate_files('qtype_hvp', 'intro', null, null);
        $hvp->annotate_files('qtype_hvp', 'content', null, null);
    ...
    public static function get_qtype_fileareas() {
        return array(
            'content' => 'question_created',
            'correctfeedback' => 'question_created',
            'partiallycorrectfeedback' => 'question_created',
            'incorrectfeedback' => 'question_created',
            'editor' => 'question_created');
    }
}

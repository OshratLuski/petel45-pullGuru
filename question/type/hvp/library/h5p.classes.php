...
namespace qtype_hvp_library;

use \DateTime as DateTime;
use \DateTimeZone as DateTimeZone;
use \ZipArchive as ZipArchive;
use \qtype_hvp_library\H5PMetadata as H5PMetadata;


require_once($CFG->dirroot . '/question/type/hvp/library/h5p-development.class.php');
/**
...
class H5PCore {
  ...
  public $librariesJsonData, $contentJsonData, $mainJsonData, $h5pF, $fs, $h5pD, $disableFileCheck, $url, $development_mode,
          $aggregateAssets, $fullPluginPath, $relativePathRegExp;
  ...
  public function __construct(H5PFrameworkInterface $H5PFramework, $path, $url, $language = 'en', $export = FALSE) {
    ...
    $this->fs = ($path instanceof \qtype_hvp_library\H5PFileStorage ? $path : new \H5PDefaultStorage($path));

    $this->url = $url;
    $this->exportEnabled = $export;
    $this->development_mode = \qtype_hvp_library\H5PDevelopment::MODE_NONE;

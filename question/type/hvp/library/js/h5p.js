...
H5P.init = function (target) {
  ...
  H5P.jQuery('iframe.h5p-iframe:not(.h5p-initialized)', target).each(function () {
    ...
    if (H5PIntegration.contentlang === false) {
      ...
      if (contentLanguage === 'he' || contentLanguage === 'ar') {
        rtlclass = 'h5p-dir-rtl';
      }
    }
    const writeDocument = function () {
      iframe.contentDocument.open();
      iframe.contentDocument.write('<!doctype html><html class="h5p-iframe ' + rtlclass + '" lang="' + contentLanguage
          + '"><head>' + H5P.getHeadTags(contentId) + '</head><body><div class="h5p-content" data-content-id="'
          + contentId + '"/></body></html>');
...
H5P.getHeadTags = function (contentId) {
    window.console.log("getHeadTags " +  contentId);

...
/**
 * Strings for component 'qtype_hvp'
 *
 * @package   qtype_hvp
 * @copyright 2022 onwards SysBind  {@link http://sysbind.co.il}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['pluginname'] = 'HVP';
$string['pleaseananswerallparts'] = 'Please answer all parts of the question.';
$string['pluginnamesummary'] = 'Use HVP Content as a question.';
$string['pluginnameadding'] = 'Adding a HVP question';
$string['pluginnameediting'] = 'Editing a HVP question';
$string['pluginname_help'] = 'HVP Question enables using HVP content as a question';
...
$string['statements'] = 'Enabled interactions';
$string['configstatements'] = 'This selected options are enabled as expected interactions.';
...
$string['hvpsettings'] = 'Settings';
$string['libraries'] = 'H5P Libraries';
$string['librariessettings'] = 'HVP Libraries';
...
// Capabilities.
$string['hvp:view'] = 'See and interact with H5P questions';
$string['hvp:addinstance'] = 'Create new H5P questions';
...
$string['hvp:savecontentuserdata'] = 'Save the users\'s progress for H5P questions';

...
/**
 * Test helpers for the essayrubric question type.
 *
...
/**
 * Test helper class for the essayrubric question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayrubric_test_helper extends question_test_helper {
     ...
     * @return qtype_essayrubric_question
     */
    protected function initialise_essay_question() {
        question_bank::load_question_definition_classes('essayrubric');
        $q = new qtype_essayrubric_question();
        test_question_maker::initialise_a_question($q);
        $q->name = 'Essayrubric question (HTML editor)';
        ...
        $q->qtype = question_bank::get_qtype('essayrubric');

        return $q;
    }

    /**
     * Makes an essayrubric question using the HTML editor as input.
     * @return qtype_essayrubric_question
     */
    ...
    /**
     * Make the data what would be received from the editing form for an essayrubric
    ...
    public function get_essay_question_form_data_editor() {
        ...
        $fromform->name = 'Essayrubric question (HTML editor)';
    ...
    /**
     * Makes an essayrubric question using the HTML editor allowing embedded files as
    ...
    public function get_essay_question_form_data_editorfilepicker() {
        ...
        $fromform->name = 'Essayrubric question with filepicker and attachments';
        $fromform->questiontext = array('text' => 'Please write a story about a frog.', 'format' => FORMAT_HTML);
        $fromform->defaultmark = 1.0;
        $fromform->generalfeedback = array('text' => 'I hope your story had a beginning, a middle and an end.', 'format' => FORMAT_HTML);
    ...
    /**
     * Makes an essayrubric question using plain text input.
     * @return qtype_essayrubric_question
     */
    ...
    /**
     * Makes an essayrubric question using monospaced input.
     * @return qtype_essayrubric_question
     */
    ...
    /**
     * Makes an essayrubric question without an online text editor.
     * @return qtype_essayrubric_question
     */

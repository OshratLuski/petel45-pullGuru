...
Feature: In a essayrubric question, limit submittable file types
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | essayrubric       | TF1   | First question  | 20          |
  ...
  Scenario: Preview an Essayrubric question and submit a response with a correct filetype.
  ...
  @javascript @_file_upload
  Scenario: Preview an Essayrubric question and try to submit a response with an incorrect filetype.
    When I log in as "student"
    And I follow "Manage private files"

...
Feature: Test duplicating a quiz containing an Essayrubric question
  As a teacher
  In order re-use my courses containing Essayrubric questions
  ...
  @javascript
  Scenario: Backup and restore a course containing 3 Essayrubric questions
    ...
    And I should see "essayrubric-002"
    And I should see "essayrubric-003"
    ...
    And I press "Cancel"
    And I choose "Edit question" action for "essayrubric-002" in the question bank
    Then the following fields match these values:
      ...
      | Require text               | Require the student to enter text                       |
    And I press "Cancel"
    And I choose "Edit question" action for "essayrubric-003" in the question bank
    Then the following fields match these values:

@editor @qtype @qtype_essayrubric @javascript
Feature: Set editor values when the editor is not in a form
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | essayrubric | essayrubric | editorfilepicker |

  Scenario: Preview an Essayrubric question that uses the HTML editor with embedded files.
    When I am on the "essayrubric" "core_question > preview" page logged in as teacher

...
class qtype_oumultiresponse extends question_type {
    ...
    public function save_question_options($question) {
        ...
        foreach ($question->answer as $key => $answerdata) {
            ...
            $is_combinbed = !empty($question->parent);
            if ($is_combinbed) {
                // Combined sub question
                $textfieldoptions = [
                    'trusttext' => true,
                    'subdirs' => true,
                ...
                $answer->answer_editor = ['itemid' => $answer->id, 'text' => $answer->answer, 'format' => $answerdata['format']];
                $answer->answer = file_postupdate_standard_editor(
                // The submitted data.
                    $answer,
                    ...
                    $context,
                    'question', //'qtype_oumultiresponse',
                    'answer',
                    $answer->id
                )->answer;
            }

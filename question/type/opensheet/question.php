...
/**
 * Opensheet question definition class.
 *
 * @package    qtype
...
/**
 * Represents an opensheet question.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_opensheet_question extends question_with_responses {
    ...
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_opensheet', 'format_' . $this->responseformat);
    }
    ...
    public function summarise_response(array $response) {
        ...
        if (isset($response['attachments'])  && $response['attachments']) {
            ...
            if ($attachedfiles) {
                $output .= get_string('attachedfiles', 'qtype_opensheet', implode(', ', $attachedfiles));
            }
        }
        return $output;
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_opensheet' && $filearea == 'graderinfo') {
    ...
    // For combinable opensheet type question.

...
abstract class question_edit_form extends question_wizard_form {
    ...
    protected function definition() {
        ...
        // EC-700.
        $buttonarraynewversion = [];
        $buttonarraynewversion[] = $mform->createElement('submit', 'saveinnewversion',
                get_string('saveinnewversion', 'local_petel'), ['class' => 'question-btn-link']);

        //$buttonarraynewversion[] = $mform->createElement('submit', 'saveinnewversionandcontinueediting',
        //    get_string('saveinnewversionandcontinueediting', 'local_petel'), ['class' => 'question-btn-link']);

        $mform->addGroup($buttonarraynewversion, 'updatebuttonar1', '', array(' '), false);
        $mform->closeHeaderBefore('updatebuttonar1');

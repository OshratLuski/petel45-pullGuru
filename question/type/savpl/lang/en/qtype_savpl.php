...
$string['disablerun'] = 'Disable Run button';
$string['disableevaluate'] = 'Disable Evaluate button';
$string['trywithoutgrade'] = 'Try without grade';
...
$string['aisupport'] = 'Enable AI support.';
$string['aisupportbtn'] = 'AI support';
$string['aisupportbtnwithleft'] = 'AI support ({$a} left)';
$string['aiteacherprompt'] = 'AI teacher prompt (you may leave this field blank)';
$string['ainumrequests'] = 'AI number of requests (0 or blank for unlimited)';
$string['aiabuseattempt'] = 'Failed to identify your attept to request AI aupport, please contact your administrator';
$string['ainosupportleft'] = 'You have no requests left!';
$string['respcopybtn'] = 'VPL window Copy';
$string['respcopyconfirmtitle'] = 'Copying a Code Segment to VPL';
$string['respcopyconfirmbody'] = 'Are you sure you want to replace the existing code with the selected code?';
$string['aisupportpromptplaceholder'] = 'Please enter your AI request here...';
$string['cfg:systemprompt'] = 'System prompt';
$string['cfg:systemprompt_help'] = 'This prompt will be added to (if exists), or replace any teacher prompt in the system';
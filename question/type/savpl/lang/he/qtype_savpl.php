...
$string['execerror'] = 'Execution output:';
...
$string['disablerun'] = 'הסתר כפתור הרצה';
$string['disableevaluate'] = 'הסתר כפתור הערכה';
$string['trywithoutgrade'] = 'התנסות ללא ציון';
...
$string['aisupportbtn'] = 'הנחיית AI';
$string['aisupportbtnwithleft'] = 'הנחיית AI ({$a} נותרו)';
...
$string['respcopybtn'] = 'העתק קוד ל- VPL';
$string['respcopyconfirmtitle'] = 'העתקת מקטע קוד ל-VPL';
$string['respcopyconfirmbody'] = 'האם אתם בטוחים שברצונכם להחליף את קטע הקוד הקיים בקוד הנבחר?';
$string['aisupportpromptplaceholder'] = 'הקלדת הנחייה ל- AI...';

 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_savpl_question extends question_graded_automatically {
    ...
    public $disablerun;
    public $disableevaluate;
    public $trywithoutgrade;
    public $aisupport;
    public $aiteacherprompt;
    public $ainumrequests;
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseanswer', SAQVPL);
    }
    ...
    public function grade_response(array $response) {
        ...
        if ($grade !== null) {
            ...
            $vplresult->evaluationerror = get_string('nogradeerror', SAQVPL, $details);
            $grade = 0;
        }
        ...
        if ($this->trywithoutgrade) {
            return array(0, question_state::graded_state_for_fraction($grade));
        }

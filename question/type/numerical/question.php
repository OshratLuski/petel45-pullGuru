...
class qtype_numerical_question extends question_graded_automatically {
    ...
    public function is_complete_response(array $response) {
        ...
        if($this->if_autocomplete_enable()) {
            list($num, $unit) = qtype_numerical\autocomplete::split_answer($response['answer']);
    ...
    public function get_matching_answer($value, $multiplier) {
        ...
        if($this->if_autocomplete_enable()) {
            list($num, $unit) = qtype_numerical\autocomplete::split_answer($value);
...
//            }
            ...
            foreach ($this->answers as $answer) {
                ...
                if (qtype_numerical\autocomplete::compare_answer($given, $answert, $answer->tolerance)) {
            ...
            foreach ($this->answers as $answer) {
                ...
                $obj = qtype_numerical\autocomplete::check_for_penalty($given, $answert, $answer->tolerance);
    ...
    public function grade_response(array $response) {
        ...
        if($this->if_autocomplete_enable()) {
            $unitisright = $answer->unitisright;
        } else {

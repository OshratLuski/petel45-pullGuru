...
<html>
   ...
   <body>
      <div id="svg_editor">
         ...
         <div id="arrow_panel" class="context_panel clearfix">
            <h4><?php print_string('arrow', 'qtype_drawing');?></h4>
            <label id="tool_arrow_x1">
            <input id="arrow_x1" class="attr_changer"
                   data-title="Change arrow's starting x coordinate" size="3" data-attr="x1" pattern="[0-9]*" />
            <span><?php print_string('startx', 'qtype_drawing');?></span>
            </label>
            <label id="tool_arrow_y1">
            <input id="arrow_y1" class="attr_changer"
                   data-title="Change arrow's starting y coordinate" size="3" data-attr="y1" pattern="[0-9]*" />
            <span><?php print_string('starty', 'qtype_drawing');?></span>
            </label>
            <label id="tool_arrow_x2">
            <input id="arrow_x2" class="attr_changer"
                   data-title="Change arrow's ending x coordinate" size="3" data-attr="x2"   pattern="[0-9]*" />
            <span><?php print_string('endx', 'qtype_drawing');?></span>
            </label>
            <label id="tool_arrow_y2">
            <input id="arrow_y2" class="attr_changer"
                   data-title="Change arrow's ending y coordinate" size="3" data-attr="y2"   pattern="[0-9]*" />
            <span><?php print_string('endy', 'qtype_drawing');?></span>
            </label>
         </div>
      ...
      <div id="tools_left" class="tools_panel">
         ...
         <div class="tool_button" id="tool_arrow" title="<?php print_string('arrowtool', 'qtype_drawing');?>"></div>

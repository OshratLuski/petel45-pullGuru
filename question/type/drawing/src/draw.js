...
var svgdoc = this.svgElem_.ownerDocument;
  a_layer1 = svgdoc.createElementNS(svg_ns, "g");
  a_layer1.setAttribute("id","bananana")
this.svgElem_.appendChild(a_layer1);
*/
...
svgedit.draw.Drawing.prototype.createLayer = function(name) {
  ...
  layer_title.classList.add("grouptitle");
  layer_title.style.color = 'red';

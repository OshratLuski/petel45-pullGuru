...
(function(){
	...
	function build() {
		...
		// Arrow element
		svg.Element.arrow = function(node) {
			this.base = svg.Element.PathElementBase;
			this.base(node);
			...
			this.path = function(ctx) {
				...
				if (ctx != null) {
					...
					var arrowAngle = Math.PI / 6; // Angle of the arrowhead
					var angle = Math.atan2(points[1].y - points[0].y, points[1].x - points[0].x);
			
					// Calculate the points for the arrowhead
					var arrowPoint1 = {
						x: points[1].x - arrowLength * Math.cos(angle - arrowAngle),
						y: points[1].y - arrowLength * Math.sin(angle - arrowAngle)
					};
					var arrowPoint2 = {
						x: points[1].x - arrowLength * Math.cos(angle + arrowAngle),
						y: points[1].y - arrowLength * Math.sin(angle + arrowAngle)
		...
		svg.Element.arrow.prototype = new svg.Element.PathElementBase;

 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_varnumeric_statistics_from_steps_testcase extends mod_quiz\tests\attempt_walkthrough_testcase {
    ...
    static function get_full_path_of_csv_file(string $setname, string $test): string {

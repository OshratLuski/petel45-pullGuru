...
class qtype_essay extends question_type {
    ...
    public function save_question_options($formdata) {
        ...
        // PTL_7328 Save Allowcheck option co config, w/o adding new field to 'qtype_essay_options'.
        set_config('allowcheck_' . $formdata->id, $formdata->allowcheck ?? 0, 'qtype_essay');

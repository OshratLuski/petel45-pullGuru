    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        if ($allowcheck && self::is_interactive($qa)) {
            ...
            if ($attempt) {
                ...
                $quizattempt = \mod_quiz\quiz_attempt::create_from_usage_id($usageid);
...
class qtype_essay_format_noinline_renderer extends qtype_essay_format_renderer_base {
    ...
    public function response_area_input_combinable($name, $qa, $step, $lines, $context) {
        return '';
    }
}

...
class qtype_formulas_renderer extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        if ($realyoptions->correctness && $options->readonly) {
            $options->correctness = $realyoptions->correctness;
            $options->rightanswer = $realyoptions->rightanswer;
        }
    ...
    public function get_part_image_and_class($qa, $options, $part) {
        ...
        $sub->fraction = $sub->anscorr * $sub->unitcorr;

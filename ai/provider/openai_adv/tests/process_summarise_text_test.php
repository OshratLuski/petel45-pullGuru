...
use aiprovider_openai_adv\process_summarise_text;
use core_ai\aiactions\base;
use core_ai\provider;
use GuzzleHttp\Psr7\Response;

/**
 * Test Generate text provider class for openai_adv provider methods.
 *
 * @package    aiprovider_openai_adv
 * @copyright  2024 Matt Porritt <matt.porritt@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \aiprovider_openai_adv\provider
 * @covers     \aiprovider_openai_adv\process_summarise_text
...
final class process_summarise_text_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->responsebodyjson = file_get_contents(self::get_fixture_path('aiprovider_openai_adv', 'text_request_success.json'));

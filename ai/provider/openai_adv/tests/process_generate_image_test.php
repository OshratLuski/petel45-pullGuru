...
/**
 * Test response_base openai_adv provider methods.
 *
 * @package    aiprovider_openai_adv
 * @copyright  2024 Matt Porritt <matt.porritt@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \aiprovider_openai_adv\provider
 * @covers     \aiprovider_openai_adv\process_generate_image
 * @covers     \aiprovider_openai_adv\abstract_processor
 */
final class process_generate_image_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->responsebodyjson = file_get_contents(self::get_fixture_path('aiprovider_openai_adv', 'image_request_success.json'));
    ...
    private function create_provider(): void {
        $this->provider = new \aiprovider_openai_adv\provider();
    }
    ...
    public function test_query_ai_api_success(): void {
        ...
        $mock->append(new Response(
            ...
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(
                self::get_fixture_path('aiprovider_openai_adv', 'test.jpg'),
                'r',
            )),
        ));
    ...
    public function test_process(): void {
        ...
        $mock->append(new Response(
            200,
            ['Content-Type' => 'image/jpeg'],
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(self::get_fixture_path('aiprovider_openai_adv', 'test.jpg'), 'r')),
        ));
    ...
    public function test_process_with_user_rate_limiter(): void {
        ...
        set_config('enableuserratelimit', 1, 'aiprovider_openai_adv');
        set_config('userratelimit', 1, 'aiprovider_openai_adv');
    ...
    public function test_process_with_global_rate_limiter(): void {
        ...
        set_config('enableglobalratelimit', 1, 'aiprovider_openai_adv');
        set_config('globalratelimit', 1, 'aiprovider_openai_adv');

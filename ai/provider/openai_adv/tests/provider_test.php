...
/**
 * Test openai_adv provider methods.
 *
...
final class provider_test extends \advanced_testcase {
    ...
    public function test_is_request_allowed(): void {
        ...
        set_config('globalratelimit', 5, 'aiprovider_openai_adv');
        set_config('enableuserratelimit', 1, 'aiprovider_openai_adv');
        set_config('userratelimit', 3, 'aiprovider_openai_adv');
    ...
    public function test_is_provider_configured(): void {
        ...
        $provider = new \aiprovider_openai_adv\provider();
        $this->assertFalse($provider->is_provider_configured());

        // Properly configured values.
        set_config('apikey', '123', 'aiprovider_openai_adv');
        $provider = new \aiprovider_openai_adv\provider();

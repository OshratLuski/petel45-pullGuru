...
class process_generate_image extends abstract_processor {
    ...
    protected function get_endpoint(): UriInterface {
        return new Uri(get_config('aiprovider_openai_adv', 'action_generate_image_endpoint'));
    }

    #[\Override]
    protected function get_model(): string {
        return get_config('aiprovider_openai_adv', 'action_generate_image_model');
    }
     ...
     * that is compatible with the openai_adv API.
     *

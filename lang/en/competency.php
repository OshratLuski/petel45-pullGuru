...
$string['questioncompetencyoutcome_complete'] = 'Complete the competency';
$string['questioncompetencyoutcome_evidence'] = 'Attach evidence';
$string['questioncompetencyoutcome_none'] = 'Do nothing';
$string['questioncompetencyoutcome_recommend'] = 'Send for review';

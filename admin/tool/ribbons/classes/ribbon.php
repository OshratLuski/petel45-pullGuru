...
class ribbon {
    ...
    public function __construct(int $id) {
        ...
        if (false && !empty($default->ribbon_enabled)) {
            $this->id = 555;
            $this->position = $default->ribbon_position;
            $this->type = $default->ribbon_type;
            $this->data = $default->ribbon_data;
            $this->link = $default->ribbon_link;
            $this->colourbg = $default->ribbon_colourbg;
            $this->colourtext = $default->ribbon_colourtext;
            $this->enabled = true;
        } else {
    ...
    public static function get_default_config() : object {
        global $CFG;

        $obj = new \StdClass();
        $obj->ribbon_enabled = isset($CFG->ribbon_enabled) ? $CFG->ribbon_enabled : false;
        $obj->ribbon_position = isset($CFG->ribbon_position) ? $CFG->ribbon_position : '';
        $obj->ribbon_type = isset($CFG->ribbon_type) ? $CFG->ribbon_type : 'static';
        $obj->ribbon_data = isset($CFG->ribbon_data) ? $CFG->ribbon_data : '';
        $obj->ribbon_link = isset($CFG->ribbon_link) ? $CFG->ribbon_link : '';
        $obj->ribbon_colourbg = isset($CFG->ribbon_colourbg) ? $CFG->ribbon_colourbg : '';
        $obj->ribbon_colourtext = isset($CFG->ribbon_colourtext) ? $CFG->ribbon_colourtext : '';
...
CSS;
    ...
    public static function all(bool $enabled = null) : array {
        ...
        $default = self::get_default_config();
        if (!empty($default->ribbon_enabled)) {
            $tmp = new stdClass;
            $tmp->id = 555;
            $tmp->position = $default->ribbon_position;
            $tmp->type = $default->ribbon_type;
            $tmp->data = $default->ribbon_data;
            $tmp->link = $default->ribbon_link;
            $tmp->colourbg = $default->ribbon_colourbg;
            $tmp->colourtext = $default->ribbon_colourtext;
            $tmp->enabled = true;

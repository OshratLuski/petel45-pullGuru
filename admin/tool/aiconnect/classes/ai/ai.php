...
class ai {
     ...
     *
     * @param float $temperature The temperature value to be set.
     */
    ...
    public function clean_html($html) {
        ...
        //Remove style attributes if they are empty after the first preg_replace
        $html = preg_replace('/\s+style\s*=\s*["\']\s*["\']/i', '', $html);

        // Remove inline JavaScript (event handlers, etc.)

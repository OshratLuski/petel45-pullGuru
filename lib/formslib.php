...
MoodleQuickForm::registerElementType('mathlive', "$CFG->libdir/form/mathlive.php", 'MoodleQuickForm_mathlive');
MoodleQuickForm::registerElementType('treeselect', "$CFG->libdir/form/treeselect.php", 'MoodleQuickForm_treeselect');

...
class enrolkey_signup_form extends \login_signup_form {
    ...
    public function definition() {
        ...
        $elementdesc = $mform->createElement('static', 'signup_token_desc', '', get_string('signuptokendesc', 'auth_enrolkey'));
        ...
        $mform->insertElementBefore($element, 'usernamerestrictions');
        $mform->insertElementBefore($elementdesc, 'usernamerestrictions');

        $PAGE->requires->js_call_amd('auth_enrolkey/main', 'validate_token', []);

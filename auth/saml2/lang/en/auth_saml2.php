...
$string['error_invalidkey'] = 'Wrong Course Key, Please add the correct key.';
$string['error_page_moe_user_idnumber'] = 'Please enter your id number';
$string['error_validation_idnumber'] = 'This idnumber is not valid or it is exists in the system.';
$string['warning_send_email_subject'] = 'Warning about your petel account';
$string['warning_send_email_message'] = 'you account with idnumber {$a} have been connected to SSO of The ministry of education ';
$string['entertheregistrationkey'] = 'Enter the registration key';

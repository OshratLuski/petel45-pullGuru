 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class oer_reviews_editcomment extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id " . $this->other['userid'] . " edit comment " . $this->other['commentid'];
    }
    ...
    public static function get_name() {
        return get_string('oer_reviews_editcomment', 'community_oer');
    }

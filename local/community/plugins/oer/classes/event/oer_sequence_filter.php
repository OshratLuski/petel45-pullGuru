 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class oer_sequence_filter extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id " . $this->other['userid'] . " used sequence oercatalog";
    }
    ...
    public static function get_name() {
        return get_string('oer_sequence_filter', 'community_oer');
    }

...
class social_followed extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user id " . $this->other['userid'] . "  followed on user id " . $this->other['followuserid'];
    }
    ...
    public static function get_name() {
        return get_string('eventsocialfollowed', 'community_social');
    }

...
class decline_colleague extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user id " . $this->other['userid'] . " decline  user id " . $this->other['targetuserid'] . "  view courses";
    }
    ...
    public static function get_name() {
        return get_string('eventdeclinecolleague', 'community_social');
    }

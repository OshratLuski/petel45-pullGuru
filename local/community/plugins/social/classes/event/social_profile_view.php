...
class social_profile_view extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id " . $this->other['userid'] . " view profile user with id " . $this->other['targetuserid'];
    }
    ...
    public static function get_name() {
        return get_string('eventuserprofileview', 'community_social');
    }

 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_module_visibility_changed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcoursemodulevisibilitychanged', 'local_sharingactivities');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the '{$this->other['modulename']}' activity with " .
                "course module id '$this->contextinstanceid'. Its new visibility status is '{$this->other['action']}'.";
    }
     ...
     */
    public static function create_from_cm($cm, $modcontext, $action) {

...
class activity_to_bank_copy extends \core\event\base {
    /**
    ...
    public function get_description() {
        ...
        return "The user with id '$userid' copied activity id '$instanceid' to bank";
    }
    ...
    public static function get_name() {
        return get_string('eventactivitytobankcopy', 'community_sharewith');
    }

...
class course_copied extends \core\event\base {
    ...
    public function get_description() {
        ...
        $newcourseid = $this->other['new_courseid'];
        $oldcourseid = $this->other['old_courseid'];
        $category = $this->other['category'];
        $coursename = $this->other['name_course'];
    ...
    public static function get_name() {
        return get_string('eventcoursecopied', 'community_sharewith');
    }

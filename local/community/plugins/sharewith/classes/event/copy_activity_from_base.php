...
class copy_activity_from_base extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' copyed activity id '$this->other' from maagar homarim ";
    }
    ...
    public static function get_name() {
        return get_string('eventcopyfrommaagar', 'community_sharewith');
    }

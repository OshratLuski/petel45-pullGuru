...
class sent_activity_copy extends \core\event\base {
    /**
    ...
    public function get_description() {
        ...
        $targetuserid = $this->other['targetuserid'];
        $instanceid = $this->other['instanceid'];
        $newcourseid = $this->other['targetcourseid'];

        return "The user with id '$targetuserid' copied activity id '$instanceid' from user with id '$userid'";
    }
    ...
    public static function get_name() {
        return get_string('eventsentactivitycopy', 'community_sharewith');
    }

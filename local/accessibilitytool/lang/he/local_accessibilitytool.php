...
$string['return'] = "חזרה לעמוד הקודם";
...
/* Colour scheme */
$string['colourscheme'] = "צבעים";
$string['colourscheme_help'] = "Choose which colours are available to your users.";
$string['contrastdefault'] = "ברירת מחדל של ערכת העיצוב";
$string['contrastyb'] = "צהוב על רקע שחור";
$string['contrastby'] = "שחור על רקע צהוב";
$string['contrastwg'] = "לבן על רקע אפור";
$string['contrastbr'] = "שחור על רקע אדום";
$string['contrastbb'] = "שחור על רקע כחול";
$string['contrastbw'] = "שחור על רקע לבן";
$string['contrastgb'] = "ירוק על רקע שחור";
$string['contrastbg'] = "שחור על רקע ירוק";


/* Font style */
$string['fontstyle'] = "סגנון גופן";
$string['fontstyle_help'] = "Choose which fonts are available to your users.";
$string['fontdefault'] = "ברירת מחדל";
$string['fontmodern'] = "גופן חדשני";
$string['fontclassic'] = "גופן מסורתי";
$string['fontcomic'] = "גופן קומיק";
$string['fontmono'] = "גופן בעל ממדי אות אחידית";
$string['fontopendyslexic'] = "גופן מותאם לדיסלקציה";
...
/* Textsize */
$string['textsize'] = "גודל גופן";
$string['sizedefault'] = "גודל ברירת מחדל";
$string['sizelarge'] = "גופן גדול";
$string['sizehuge'] = "גופן גדול מאוד";
$string['sizemassive'] = "גופן גדול ביותר";
$string['sizegigantic'] = "גופן בגודל עצום";
...
$string["reset"] = 'איפוס לברירות מחדל המערכת';
$string["resethelp"] = 'איפוס לברירות מחדל המערכת';

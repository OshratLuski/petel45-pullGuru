 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bulk_metadata_update extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('copymetadataactivity', 'local_petel');
    }
    ...
    public function get_url() {
        return new \moodle_url("/local/petel/copy_metadata_activity.php", []);
    }
}

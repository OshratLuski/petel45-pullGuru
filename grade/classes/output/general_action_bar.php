...
class general_action_bar extends action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        // Add a button to the action autosort.
        $addautosortlink = new moodle_url('/grade/edit/tree/index.php', ['id' => $this->context->instanceid, 'action' => 'autosort']);
        $addautosortbutton = new \single_button($addautosortlink, get_string('autosort', 'local_petel'), 'get');

        return [
            'generalnavselector' => $selectmenu->export_for_template($output),
            'courseid' => $this->context->instanceid,
            'addautosortbutton' => $addautosortbutton->export_for_template($output),
        ];
    }

    ...
    public function __construct(assign $assignment,
        ...
        $from .= '
            LEFT JOIN (
                ...
                INNER JOIN {local_teamwork} t ON (t.id = tg.teamworkid) AND t.moduleid = :assignmentidteam
            ) AS c ON (c.userid = u.id)
        ';

        $params['assignmentidteam'] = (int)$this->assignment->get_course_module()->id;
        ...
        // Teamwork.
        $columns[] = 'teamwork';
        $headers[] = get_string('groups', 'local_teamwork');

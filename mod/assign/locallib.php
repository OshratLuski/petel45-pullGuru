...
class assign {
    ...
    protected function view_remove_submission_confirm() {
        ...
        $o .= $this->get_renderer()->confirm($confirmstr,
                                             $confirmurl,
                                             $cancelurl, ['confirmtitle' => get_string('removesubmissiontitle', 'assign')]);
        $o .= $this->view_footer();
    ...
    /**
     * Prints the status of the rubric or other grading methods if defined for the given context.
     *
     * @param int $contextid The ID of the context for which the rubric status is checked.
     * @return string HTML content of the rubric status if defined, otherwise an empty string.
     */

...
$string['selectthepopupsize'] = 'Select the map image size';
$string['openinnewwindow'] = 'Open in new window';
$string['maketransparent'] = 'Make transparent';
$string['pointsize'] = 'Point size';
$string['openmodal'] = 'Open modal';
$string['externalurl'] = 'External link';
$string['invalidurl'] = 'Invalid URL. Please enter a valid URL.';

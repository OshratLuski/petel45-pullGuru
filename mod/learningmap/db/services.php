...
define('LEARNINGMAP_VIEW_CAPABILITY', 'mod/learningmap:view');
...
$functions = [
    'mod_learningmap_get_learningmap' => [
        ...
        'type'         => 'read',
        'ajax'         => true,
        'capabilities' => LEARNINGMAP_VIEW_CAPABILITY,
    ],
    ...
    'mod_learningmap_set_externallinkcompleted' => [
        'classname'    => 'mod_learningmap\external\set_externallinkcompleted',
        'methodname'   => 'store_completed_places',
        'description'  => 'Marks a task as completed in the learningmap',
        'type'         => 'write',
        'ajax'         => true,
        'capabilities' => LEARNINGMAP_VIEW_CAPABILITY,
    ],

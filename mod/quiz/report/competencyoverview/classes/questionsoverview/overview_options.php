...
/**
 * Class to store the options for a {@link quiz_questionsoverview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_questionsoverview_options extends mod_quiz\local\reports\attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        switch ($display_blocks) {
            case "basic":$this->slotmarks = 0;
                break;
            case "full":$this->slotmarks = 1;
                break;
            default:$this->slotmarks = get_user_preferences('quiz_questionsoverview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function update_user_preferences() {
        ...
        if (quiz_has_grades($this->quiz)) {
            set_user_preference('quiz_questionsoverview_slotmarks', $this->slotmarks);
        }
    }

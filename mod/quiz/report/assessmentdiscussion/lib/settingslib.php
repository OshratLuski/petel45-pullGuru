 ...
 */
class assessmentdiscussion_admin_setting_config_multicheckbox_with_icon extends admin_setting_configmulticheckbox {
...
class assessmentdiscussion_admin_setting_config_multiselect_with_icon extends admin_setting {
 ...
 */
class assessmentdiscussion_admin_setting_question_types extends assessmentdiscussion_admin_setting_config_multiselect_with_icon {
    /**
     * @param string $name
     ...
     */
    public function __construct($name, $visiblename, $description, $excludeqtypes = [], $defaultsetting = null) {
        global $OUTPUT;
        $choices = array();
        $icons = array();
        ...
        foreach (question_bank::sort_qtype_array($qtypenames) as $qname => $label) {
            if (!in_array($qname, $excludeqtypes)) {
                $choices[$qname] = $label;
        ...
        $select = [
                PROFILE_VISIBLE_NONE => get_string('disable'),
                PROFILE_VISIBLE_PRIVATE => get_string('enable')
        ];

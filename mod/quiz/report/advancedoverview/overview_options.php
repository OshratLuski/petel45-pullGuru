 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_advancedoverview_options extends mod_quiz\local\reports\attempts_report_options {
     ...
     */
    public $attempts = mod_quiz\local\reports\attempts_report::ENROLLED_ALL;
    ...
    public function setup_from_form_data($fromform) {
        ...
        $this->slotmarks = isset($fromform->slotmarks) ? $fromform->slotmarks : false;
    }
    ...
    public function setup_from_user_preferences() {
        ...
        $displayblocks = optional_param('display', 'basic', PARAM_TEXT);

        switch ($displayblocks) {
            case "basic":
                $this->slotmarks = 0;
                break;
            case "full":
                ...
                break;
            default:
                $this->slotmarks = get_user_preferences('quiz_advancedoverview_slotmarks', $this->slotmarks);
        }
    ...
    public function update_user_preferences() {
        ...
        if (quiz_has_grades($this->quiz)) {
            set_user_preference('quiz_advancedoverview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        if ($this->attempts == mod_quiz\local\reports\attempts_report::ENROLLED_WITHOUT) {

...
/**
 * The mod_quiz attempt closed event.
 *
 * @package    mod_quiz
...
/**
 * The mod_quiz attempt closed event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_closed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptclosed', 'mod_quiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' closed the attempt with id '$this->objectid' belonging to the quiz " .

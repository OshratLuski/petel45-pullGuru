...
if ($page == -1) {
    ...
    if ($mdlscrollto !== '') {
        $mdlscrollto = intval($mdlscrollto);
...
$showsummary = $lqsoptions->show_summary == 1 ? true : false;

$forcesubmit = optional_param('forcesubmit', 0, PARAM_INT);

// Force submit button.
if ($forcesubmit && !$showsummary) {
    $finishattempt = true;
}

// Normal submit button.
if (!$forcesubmit && !$showsummary && $page == -1) {
    $finishattempt = true;
}

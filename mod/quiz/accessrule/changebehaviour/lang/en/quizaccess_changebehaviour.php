...
$string['pluginname'] = 'Extend the close time';
$string['behaviourtime_abs'] = 'Extend the close time';
$string['behaviourtime_abs_help'] = 'Set a new close time or an amount of time to extend the quiz and a new behaviour to apply to attempts started after the original close. This is an opportunity to change the conditions for students who wait too late to attempt the quiz.';
$string['behaviourtime_relative'] = 'Extend by close relative time';
...
$string['penalty'] = 'Penalty for late submission';
$string['penalty_help'] = 'Penalty points taken off for late submission';

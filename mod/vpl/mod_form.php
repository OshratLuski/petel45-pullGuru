...
class mod_vpl_mod_form extends moodleform_mod {
    protected function definition() {
        ...
        $mform->addElement( 'hidden', 'shortdescription', get_string( 'shortdescription', VPL ), [
                'cols' => 70,
                'rows' => 1,
        ] );
        ...
        //PTL_7538
        $mform->addElement( 'hidden', 'evaluate', isset($plugincfg->evaluate) ? $plugincfg->evaluate : '' );
        $mform->setType( 'evaluate', PARAM_RAW );

...
class block_analytics_graphs_event_send_email extends \core\event\base {
    ...
    public function get_description() {
        return "User: {$this->userid} - Course: {$this->objectid} - Graph: {$this->other['graph']}";
    }

    public function get_url() {
        return new \moodle_url('/blocks/analytics_graphs/' . $this->other['graph'], array('id' => $this->objectid, 'legacy' => '0'));
    }

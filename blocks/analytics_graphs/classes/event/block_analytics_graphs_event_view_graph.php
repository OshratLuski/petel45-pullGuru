...
class block_analytics_graphs_event_view_graph extends \core\event\base {
    ...
    public function get_description() {
        return "User: {$this->userid} - Course: {$this->objectid} - Graph: {$this->other['file']}";
    }

    public function get_url() {
        return new \moodle_url('/blocks/analytics_graphs/' . $this->other['file'], array('id' => $this->objectid, 'legacy' => '0'));
    }
}
